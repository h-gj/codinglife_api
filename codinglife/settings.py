"""
Django settings for codinglife project.
...
SECRET_KEY = 'ca*myz=_e75w7i-6^6y)8c)z)@#+*um3^@-^&yxx0__a(r)4l('
...
WSGI_APPLICATION = 'codinglife.wsgi.application'
